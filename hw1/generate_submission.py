from neural_networks import layers, models
import argparse
import inspect
...
student_implementations = {
    "Activation Function Implementations:": [
        "layers.activations.Identity",
        "layers.activations.Sigmoid",
        "layers.activations.ReLU",
        "layers.activations.SoftMax",
    ],
    "Layer Implementations:": [
        "layers.fully_connected.FullyConnected",
    ],
    "Loss Function Implementations:": ["layers.losses.CrossEntropyLoss"],
